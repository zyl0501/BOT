 ...
 */
@Action(path = "/student2")
@Interceptor(clz = {UserInterceptor.class,UserInterceptor3.class})
public class StudentAction2 implements ModuleAction<Integer, StudentModule> {
  @Override
