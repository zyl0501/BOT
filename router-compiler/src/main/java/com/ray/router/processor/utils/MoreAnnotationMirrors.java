...
public final class MoreAnnotationMirrors {
   ...
   */
  public static ImmutableList<AnnotationValue> asAnnotationValues(
   ...
   */
  public static Iterable<TypeMirror> getTypeValue(AnnotationMirror annotationMirror, String name) {
    return FluentIterable.from(asAnnotationValues(getAnnotationValue(annotationMirror, name)))
        .transform(new Function<AnnotationValue, TypeMirror>() {
          @Override public TypeMirror apply(AnnotationValue annotationValue) {
